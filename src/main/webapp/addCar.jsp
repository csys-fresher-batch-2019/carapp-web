			...
			<tbody>
				<tr>
					...
					<td>: <input type="text" name="carName" id="carName"
						placeholder="Ex:figo" required /></td>
				</tr>
				<tr>
					<td>Car Brand</td>
					<td>: <input type="text" name="carBrand" id="carBrand"
						placeholder="ford" required /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>: <input type="text" name="regState" id="regState"
						placeholder="Ex:Tamilnadu" required /></td>
				</tr>
				<tr>
					<td>Car Available City</td>
					<td>: <input type="text" name="carAvailableCity"
						id="carAvailableCity" placeholder="Ex:chennai" required /></td>
				</tr>
				<tr>
					<td>Registered Year</td>
					<td>: <input type="number" name="regYear" id="regYear"
						placeholder="Ex:2000" required onblur="validateYear(this.value)" /></td>
				</tr>
				<tr>
					<td>Driven Kilometer</td>
					<td>: <input type="number" name="drKm" id="drKm"
						maxlength="10" pattern="^[0-9]" title="Enter Km correctly" min="1"
						placeholder="Ex:DrivenKm" required /></td>
				</tr>
				<tr>
					<td>Registration Number</td>
					<td>: <input type="text" name="regNo" id="regNo" required
						placeholder="Ex:TN00NH3433"
				...
				<tr>
					...
					<td>: <input type="text" name="vid" maxLength="17"
						pattern="[0-9]{1}[A-Z]{4}[0-9]{2}[A-Z]{4}[0-9]{6}"
				...
				<tr>
					...
					<td>: <input type="number" name="price" id="price"
						placeholder="Ex:100000" min=300000 pattern="^[0-9]"
						title="Give valid price" required /></td>
				</tr>
				<tr>
					<td>Are You owner</td>
				...
				<tr>
					<td>Car Image Source</td>
					<td>: <input type="text" name="image" placeholder="image.jpg" /></td>
				</tr>
				<tr>
					<td></td>
					<td align="right"><button type="submit" onclick="myfunction()"
