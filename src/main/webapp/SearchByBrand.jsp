		...
		<div class="left">
			<div class="card-desk" class="left">
				<div class="card" style="width: 18rem; height: 20rem">
					<img src="assets/images/<%=cdl.getImageSrc()%>"
					...
					<div class="card-body">
						...
						<h6 class="card-text">
							Registration year:<%=cdl.getRegYear()%></h6>
						<h6>
							DrivenKm:<%=cdl.getDrivenKm()%></h6>
						<h6>
							price:<%=cdl.getPrice()%></h6>
						<a href="SearchCarServlet?carId=<%=cdl.getCarId()%>" class="right"
							class="madal-title"><span class="orange">view Detail></span></a>
					</div>
				</div>
			</div>
		</div>
